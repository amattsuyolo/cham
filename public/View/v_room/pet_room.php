                ...
                <h5><pre>
{
    ...
    "returnData": {
        ...
        "furniture_info": [
            {
                "furniture_id": "7",
                "furniture_icon": "room_toy_010",
                "furniture_effect": ""
            },
            {
                "furniture_id": "1",
                "furniture_icon": "room_toy_008",
                "furniture_effect": ""
            }
        ]
    }
                ...
                <div class="table-responsive">
                    ...
                    <h5>其中returnData裡的主要是會員與房間相關資訊：</h5>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>furniture_info</td>
                                <td>integer</td>
                                <td>furniture_id:道具流水號<br>
                                    furniture_icon:道具圖檔<br>
                                    furniture_effect:道具效果
                                </td>
                            </tr>
                ...
                <h4>最後更新日:2018/12/13</h4>
                <br>
                <h3>更新紀錄：</h3>

                <h4>1. 2018/12/13 : 建立文件。</h4>
            </div>
        </div>
    </div>
</body>
